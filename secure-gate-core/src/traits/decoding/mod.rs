...
//! `Fixed::try_from_hex`, `Fixed::try_from_base32`, `Fixed::try_from_base64url`, etc. — these
//! decode directly into a stack-allocated buffer. Treat all input as untrusted. Prefer
//! HRP-validated bech32 methods.
