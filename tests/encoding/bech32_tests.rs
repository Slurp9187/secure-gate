...
// Ensures validation, normalization, variant detection, metadata, and round-tripping.
...
fn accepts_and_normalizes_valid_bech32m() {
    // Confirmed valid Bech32m vectors (short and medium length, avoiding ultra-long HRP edge cases)
    let vectors = [
        ("A1LQFN3A", "a1lqfn3a"),
        (
    ...
    // Real-world Taproot Bech32m (witness version 1)
    let taproot_mixed =
