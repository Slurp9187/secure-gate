...
// without an explicit user-provided impl SerializableSecret for the inner type T.
//
// Expected failures:
// - No Serialize for Fixed<[u8; 32]> (missing SerializableSecret on [u8; 32])
// - No Serialize for Dynamic<String> (missing SerializableSecret on String)
