...
- Additional encodings if requested.

## Post-1.0
- HSM/TPM integrations.
- Formal security audits.
- Community-driven features (e.g., i18n if needed).

Priorities flexible based on feedback—open issues/PRs welcome!
