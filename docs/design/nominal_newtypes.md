...
> compile-fail snapshots are blessed on 1.70. Verification numbers and toolchain
> references below are `main`'s.
...
3. ✅ Rustdoc in house style on both macros: syntax block, all visibility
   ...
   `README.md` (macro section rewritten, security bullet
