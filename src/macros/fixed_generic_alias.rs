...
///
/// See also [`fixed_alias!`](crate::fixed_alias) (preferred when size is known at the
/// call site) and [`dynamic_generic_alias!`](crate::dynamic_generic_alias) (heap alternative).
#[macro_export]
