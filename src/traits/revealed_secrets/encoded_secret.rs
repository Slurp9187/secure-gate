...
//! [`docs/design/encoded_secret_deref.md`](https://github.com/Slurp9187/secure-gate/blob/main/docs/design/encoded_secret_deref.md)
...
impl EncodedSecret {
    ...
    /// with no zeroize-on-drop and no redacted `Debug`. Every later copy â€” a
    /// `format!`, a log line, a `Clone`, a `serde` round-trip â€” is an ordinary
